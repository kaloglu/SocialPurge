...
import zao.kaloglu.com.socialpurge.components.SimpleValueEventListener
import zao.kaloglu.com.socialpurge.helpers.bases.BaseActivity
import zao.kaloglu.com.socialpurge.models.AccountObject
import zao.kaloglu.com.socialpurge.models.FirebaseObject
...
class FirebaseService {
    ...
    fun String?.putSingleValueEventListener(
            simpleValueEventListener: SimpleValueEventListener,
            vararg childArray: String
    ) = this.putValueEventListener(true, simpleValueEventListener, *childArray)
    ...
    fun String?.putChildEventListener(childEventListener: SimpleChildEventListener, vararg childArray: String) = getDBRefWithUID(*childArray).addChildEventListener(childEventListener)

    fun Query.putChildEventListener(childEventListener: SimpleChildEventListener) = this.addChildEventListener(childEventListener)
