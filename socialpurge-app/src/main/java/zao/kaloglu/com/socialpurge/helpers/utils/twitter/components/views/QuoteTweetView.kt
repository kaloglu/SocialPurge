...
(context: Context, timelineDelegate: TimelineDelegate) :
        zao.kaloglu.com.socialpurge.helpers.utils.twitter.components.views.AbstractTweetView(
                context,
                null,
                0,
                timelineDelegate
    ...
    override fun getLayout(): Int = zao.kaloglu.com.socialpurge.R.layout.tw__tweet_quote
    ...
    protected fun applyStyles() {
        ...
        setBackgroundResource(zao.kaloglu.com.socialpurge.R.drawable.tw__quote_tweet_border)
