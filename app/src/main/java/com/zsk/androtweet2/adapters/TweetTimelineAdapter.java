...
import com.zsk.androtweet2.components.twitter.BaseTimeline;
 ...
 * RecyclerViews.
 */
public class TweetTimelineAdapter extends
    ...
    protected TweetTimelineAdapter(Context context, Timeline<Tweet> timeline,
                                   int styleResId, Callback<Tweet> cb) {
        this(context, new TimelineDelegate<>(timeline), styleResId, cb, TweetUi.getInstance());
    }

    private TweetTimelineAdapter(Context context, TimelineDelegate<Tweet> timelineDelegate,
    ...
    TweetTimelineAdapter(Context context,
        ...
        this.timelineDelegate.refresh(new Callback<TimelineResult<Tweet>>() {
            ...
            public void success(Result<TimelineResult<Tweet>> result) {
                ...
                previousCount = TweetTimelineAdapter.this.timelineDelegate.getCount();
            }
            ...
            public void onChanged() {
                ...
                if (previousCount == 0) {
                    ...
                    notifyItemRangeInserted(previousCount,
                            TweetTimelineAdapter.this.timelineDelegate.getCount()
                                    - previousCount);
                }
                previousCount = TweetTimelineAdapter.this.timelineDelegate.getCount();
            }
...
//        compactTweetView.setOnActionCallback(actionCallback);
    ...
    public static class Builder {
        ...
        private int styleResId = com.twitter.sdk.android.tweetui.R.style.tw__TweetLightStyle;
         ...
         */
        public TweetTimelineAdapter.Builder setTimeline(Timeline<Tweet> timeline) {
         ...
         */
        public TweetTimelineAdapter.Builder setViewStyle(int styleResId) {
            this.styleResId = styleResId;
            return this;
        }
         ...
         */
        public TweetTimelineAdapter.Builder setOnActionCallback(
         ...
         */
        public TweetTimelineAdapter.Builder setTimelineFilter(
        ...
        /**
         * Builds a TweetTimelineAdapter from Builder parameters.
         *
         * @return a TweetTimelineListAdpater
         */
        public TweetTimelineAdapter build() {
                return new TweetTimelineAdapter(context, timeline, styleResId,
                        actionCallback);
        }
    }
}
