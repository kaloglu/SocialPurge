...
public class TweetModel implements Identifiable {
    ...
    public final TweetModel quotedStatus;
    ...
    public final TweetModel retweetedStatus;
    ...
    public TweetModel(Coordinates coordinates, String createdAt, Object currentUserRetweet,
                      ...
                      TweetModel quotedStatus, int retweetCount, boolean retweeted, TweetModel retweetedStatus,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TweetModel)) return false;
        final TweetModel other = (TweetModel) o;
